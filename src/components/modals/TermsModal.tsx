      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full border border-slate-200 overflow-hidden my-8 max-h-[85vh] flex flex-col text-left">
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-xs sm:text-sm text-slate-700 leading-relaxed">
          ...
          <section className="space-y-2">
            <h4 className="font-bold text-slate-900 text-sm">1. Nature of Enquiry Forms</h4>
            <p>
          ...
          <section className="space-y-2">
            <h4 className="font-bold text-slate-900 text-sm">2. Client Accuracy Representation</h4>
            <p>
          ...
          <section className="space-y-2">
            <h4 className="font-bold text-slate-900 text-sm">3. Timely Information Submission</h4>
            <p>
          ...
          <section className="space-y-2">
            <h4 className="font-bold text-slate-900 text-sm">4. Professional Ethics &amp; Confidentiality</h4>
            <p>
