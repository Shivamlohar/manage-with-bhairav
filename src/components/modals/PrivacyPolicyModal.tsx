...
export const PrivacyPolicyModal: React.FC<PrivacyPolicyModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full border border-slate-200 overflow-hidden my-8 max-h-[85vh] flex flex-col text-left">
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-xs sm:text-sm text-slate-700 leading-relaxed">
          ...
          <section className="space-y-2">
            <h4 className="font-bold text-slate-900 text-sm">3. How Your Information is Used</h4>
            <p>
          ...
          <section className="space-y-2">
            <h4 className="font-bold text-slate-900 text-sm">4. Critical Security Rule</h4>
          ...
          <section className="space-y-2">
            <h4 className="font-bold text-slate-900 text-sm">5. Contact Regarding Privacy</h4>
            <p>
              If you have any questions about how your documents or data are handled, please contact our official desk at <span className="font-semibold">{brandConfig.email.display}</span> or call <span className="font-semibold">{brandConfig.phone.display}</span>.
            </p>
          </section>
        </div>
